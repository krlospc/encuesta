...
class Formulario3Controller extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            $em = $this->getDoctrine()->getManager();
            if ($request->get('departamento') <>"" and $request->get('codigounidadeducativa')<>"" and $request->get('numeroboleta')<>"" ){
                ...
                if(!$entity){
                     ...
                     */
                        ...
                        $estudiante->setp1Ue(strtoupper($request->get('p1unidadeducativa')));
                        $estudiante->setp2Nombres(strtoupper($request->get('p2nombres')));
                        $estudiante->setp3Paterno(strtoupper($request->get('p3paterno')));
                        $estudiante->setp4Materno(strtoupper($request->get('p4materno')));
                        ...
                        $estudiante->setp8noUe(strtoupper($request->get('p8nomue')));
                        $estudiante->setp9AnioEscolaridad2016(strtoupper($request->get('p9añoesc2016')));
                        $estudiante->setp10AnioEscolaridad2018(strtoupper($request->get('p10añoesc2018')));
                        $estudiante->setp11Rude(strtoupper($request->get('p11codrue')));
                        ...
                        $estudiante->setp139Razon(strtoupper($request->get('p1427razon_1')));
                        ...
                        $estudiante->setp19Primera(strtoupper($request->get('p19primerarazon')));
                        $estudiante->setp19Segunda(strtoupper($request->get('p19segundarazon')));
                        $estudiante->setp19Tercera(strtoupper($request->get('p19tercerarazon')));
                        $estudiante->setp19Cuarta(strtoupper($request->get('p19cuartarazon')));
                        $estudiante->setp19Quinta(strtoupper($request->get('p19quintarazon')));
                        $estudiante->setp19Otra(strtoupper($request->get('p19otra')));
                        $estudiante->setp20Nombre(strtoupper($request->get('p20nombre')));
                        $estudiante->setp20Cargo(strtoupper($request->get('p20cargo')));
                        //dump($estudiante);die;
                        ...
                        $request->getSession()
                        ->getFlashBag()
                        ->add('error', 'Debe completar la información para el formulario'); 
            }
